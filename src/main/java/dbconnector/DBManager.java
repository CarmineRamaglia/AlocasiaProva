...
public class DBManager {
    ...
    public static final String JDBC_URL_MySQL = "jdbc:mysql://localhost:3306/jdbc_alocasia?user=Alocasia&password=$Alocasia191210020104$&serverTimezone=" + TimeZone.getDefault().getID();
